package com.backenddev.learning.Strings.Backtracking;
 ...
 * <h5>Complexities:</h5>
 * <ul>
 *   <li>Time complexity: O(4^n / âˆšn) - Catalan number complexity.</li>
 *   <li>Space complexity: O(4^n / âˆšn) for storing all combinations.</li>
 * </ul>
 */
