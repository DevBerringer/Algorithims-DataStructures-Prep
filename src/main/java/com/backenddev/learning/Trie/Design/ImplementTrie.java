package com.backenddev.learning.Trie.Design;
...
public class ImplementTrie {
    ...
    public static class Trie {
        ...
        */
         ...
         */
        private boolean deleteHelper(TrieNode node, String word, int index, boolean[] deleted) {
            ...
            boolean shouldDeleteChild = deleteHelper(node.children[charIndex], word, index + 1, deleted);
